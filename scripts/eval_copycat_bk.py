...
class MyVisulizer(Visualizer):
    def __init__(self, vis_file):
        ...
        self.env_vis.model.geom_rgba[ngeom + 2 : 49] = np.array([0.7, 0.0, 0.0, 1])
    ...
    def update_pose(self):
        ...
        self.env_vis.data.qpos[env.model.nq + 2] = 100
...
if __name__ == "__main__":
    ...
    if args.data == "singles" or args.mode == "disp_stats":
        cfg.data_specs[
            "test_file_path"
        ] = "/hdd/zen/data/ActBound/AMASS/amass_copycat_test_singles.pkl"
    if args.data == "singles_train":
        cfg.data_specs[
            "test_file_path"
        ...
        cfg.data_specs[
            "test_file_path"
        ] = "/hdd/zen/data/ActBound/AMASS/amass_copycat_take4.pkl"
    elif args.data == "test":
        cfg.data_specs[
            "test_file_path"
        ] = "/hdd/zen/data/ActBound/AMASS/amass_copycat_take3_test.pkl"
    elif args.data == "usr":
        pass

    # cfg.mujoco_model_file = "/hdd/zen/dev/copycat/Copycat/assets/mujoco_models/humanoid_smpl_neutral_bigfoot.xml"
    # args.vis_model_file = "humanoid_smpl_neutral_bigfoot_vis"
    # cfg.mujoco_model_file = "/hdd/zen/dev/copycat/Copycat/assets/mujoco_models/MPH8.xml"
    # args.vis_model_file = "MPH8_vis"
    args.vis_model_file = cfg.vis_model_file
    ...
    """make and seed env"""
    model = load_model_from_path(cfg.vis_model_file)
    if args.mode != "stats":
        sim = MjSim(model)
        viewer = MjViewer(sim)
    ...
    if args.mode == "stats":
        ...
        value_net.to(device)
        vis = MyVisulizer(cfg.vis_model_file)
        if args.mode == "vis":
            vis.show_animation()
